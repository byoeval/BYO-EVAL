...
from poker.config.models import PokerSceneModel, PlayerModel, RiverModel, PlayerHandModel, ChipAreaConfig, ChipPileModel, ChipModel, CardOverlapModel
...
class PokerConfigToLegend:
    ...
    def _format_vector(self, vec: Optional[Union[Tuple, List]], precision: int = 3) -> str:
    ...
    # --- Card Overlap Layout ---
    def get_card_overlap_dict(self) -> Optional[Dict[str, Any]]:
    ...
    # --- Community Cards --- 
    def get_community_cards_dict(self) -> Optional[Dict[str, Any]]:
    ...
    def _get_chip_area_dict(self, chip_area_model: Optional[ChipAreaConfig], resolved_piles: Optional[List[Dict[str, Any]]]) -> Optional[Dict[str, Any]]:
    ...
    def _get_chip_area_text(self, chip_area_model: Optional[ChipAreaConfig], resolved_piles: Optional[List[Dict[str, Any]]]) -> str:
    ...
    # --- Noise Config ---
    def get_noise_config_dict(self) -> Optional[Dict[str, Any]]:
...
if __name__ == "__main__":
    ...
    try:
        ...
        if txt_file and json_file:
             logger.info(f"Successfully generated legends:")
