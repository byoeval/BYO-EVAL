...
from poker.load_chip import load_chip, _DEFAULT_CHIPS_BLEND_FILE 
...
def build_chip_area_from_config(
    config: Union[Dict, ChipAreaConfig],
    area_center_location: Tuple[float, float, float],
    resolved_pile_configs: Optional[List[Dict[str, Any]]] = None # List of resolved configs per pile
    ...
    """
    all_chips = []
    area_config: Optional[ChipAreaConfig] = None
    ...
    try:
        ...
        base_pile_model: Optional[ChipPileModel] = None
