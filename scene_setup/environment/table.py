import bpy
from scene_setup.models import TableModel, TableShape, TableTexture, MaterialModel
...
def test_table():
    ...
    from scene_setup import build_camera_from_config
    from scene_setup import setup_lighting
    from scene_setup import create_floor
    from scene_setup import setup_render
